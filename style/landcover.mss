// --- MapTiler-подобные мягкие тона ---

@grass: #f0f8f0;        // Очень светлый зеленый
@scrub: #f5f8f5;        // Почти белый с зеленым оттенком
@forest: #e8f0e8;       // Очень светлый зеленый
@forest-text: #4a6b4a;  // Мягкий темно-зеленый для текста
@park: #f8faf8;         // Почти белый
@allotments: #f2f5f2;   // Очень светлый зеленый
@orchard: #f5f8f5;      // Очень светлый зеленый
@hedge: @forest;        // Тот же зеленый

// --- MapTiler-подобные базовые цвета ---

@built-up-lowzoom: #f8f8f8;
@built-up-z12: #fafafa;
@residential: #fcfcfc;      // Почти белый
@residential-line: #f0f0f0; // Очень светло-серый
@retail: #f8faf8;           // Очень светлый зеленый
@retail-line: #f0f2f0;      // Очень светло-зеленый
@commercial: #fafafa;       // Почти белый
@commercial-line: #f0f0f0;  // Очень светло-серый
@industrial: #f8f8f8;       // Очень светло-серый
@industrial-line: #f0f0f0;  // Очень светло-серый
@farmland: #f8faf8;         // Очень светлый зеленый
@farmland-line: #f0f2f0;    // Очень светло-зеленый
@farmyard: #fafafa;         // Почти белый
@farmyard-line: #f0f0f0;    // Очень светло-серый

// --- Транспорт (MapTiler-стиль) ---

@transportation-area: #fafafa;
@apron: #f8f8f8;
@garages: #fcfcfc;
@parking: #fefefe;
@parking-outline: #f0f0f0;
@railway: @industrial;
@railway-line: @industrial-line;
@rest_area: #f8faf8; // Очень светлый зеленый

// --- Остальные цвета (MapTiler-стиль) ---

@bare_ground: #fafafa;
@campsite: #f8faf8; // Очень светлый зеленый
@cemetery: #f5f8f5; // Очень светлый зеленый
@construction: #f8f8f8; // Очень светло-серый
@heath: #f8faf8; // Очень светлый зеленый
@mud: rgba(248,250,248,0.3); // Очень светлый зеленый с прозрачностью
@place_of_worship: #fafafa; // Почти белый
@place_of_worship_outline: #f0f0f0;
@leisure: #f8faf8; // Очень светлый зеленый
@power: @industrial;
@power-line: @industrial-line;
@sand: #fcfcfc; // Почти белый
@societal_amenities: #fefefe; // Почти белый
@tourism: #4a6b4a; // Мягкий темно-зеленый
@quarry: #f8f8f8; // Очень светло-серый
@military: #ff8a8a; // Мягкий красный
@beach: #fcfcfc; // Почти белый
@wastewater_plant: @industrial;
@wastewater_plant-line: @industrial-line;
@water_works: @industrial;
@water_works-line: @industrial-line;

// --- Спорт (MapTiler-стиль) ---

@pitch: #f8faf8;           // Очень светлый зеленый
@track: @pitch;
@stadium: @leisure; // Очень светлый зеленый
@golf_course: @campsite; // Очень светлый зеленый
